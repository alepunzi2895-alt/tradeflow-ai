...
## 2026-09-24 — S35_ASIA_BREAK live su demo (scalp M5, blocco isolato)

Rottura del range asiatico (02-10 broker) tra le 10 e le 14, SL a metà range, parziale a 1R + pareggio, TP 2R, time-stop 24h, lotto fisso 0.03. Ricerca e numeri: `05_backtest.md` 2026-09-24 (M5 17 mesi: WR 55.5%, PF 1.61, 4/4 fold, holdout PF 1.68; combo con il roster circa 1.2 trade/giorno XAU, PF 1.83). DSR non significativo → test demo per scelta utente. Dettagli operativi: `04_bot_operations.md`.
