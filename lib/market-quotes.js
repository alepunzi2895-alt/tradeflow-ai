...
export const QUOTE_SYMBOLS = {
  XAU: ['OANDA:XAUUSD','FOREXCOM:XAUUSD','TVC:GOLD'],
  XAG: ['OANDA:XAGUSD','FOREXCOM:XAGUSD','TVC:SILVER'],
  US30: ['OANDA:US30USD','TVC:DJI','DJCFD:DJI'],
  DXY: ['TVC:DXY'], EURUSD: ['OANDA:EURUSD','FX:EURUSD'],
  GBPUSD: ['OANDA:GBPUSD','FX:GBPUSD'], OIL: ['FX:USOIL','TVC:USOIL'],
...
export async function fetchQuotes() {
  ...
  try {
    const response=await fetchT('https://scanner.tradingview.com/global/scan',{
      ...
      body:JSON.stringify({symbols:{tickers:Object.values(QUOTE_SYMBOLS).flat(),query:{types:[]}},columns:['close','change','high','low']})
    });
