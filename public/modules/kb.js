...
async function processKbFile(file){
  ...
  try{
    ...
    const reply=await api([{role:'user',content:[part,{type:'text',text:`Estrai le regole di trading ${instrumentLabel(window.activeAsset)} rilevanti. Entry, risk management, pattern, indicatori, psicologia. Conciso. Italiano.`}]}],
