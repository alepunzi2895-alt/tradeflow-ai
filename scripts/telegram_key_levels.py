...
NOTA 2026-09-07: questo modulo si chiamava inizialmente key_levels.py, ma quel nome era
già usato dal KeyLevelsAgent di produzione (S/R detection per TP snapping/SL avoidance,
importato da mt5-bot.py) — sovrascritto per errore e ripristinato dalla history git.
Rinominato per evitare la collisione; NON ha nulla a che fare con KeyLevelsAgent.
"""
import bisect
import datetime
